...
#define XMODEL_PATH                     "test_4_compiled.xmodel"

#define TEST_C3_RESULT_CSV_PATH         "test_C3_kv260_results_cpp.csv"
#define TEST_C3_POWER_RESULT_CSV_PATH   "test_C3_kv260_power_results_cpp.csv"
 ...
 */
void TestC3(const std::vector<string>& image_paths, 
            ...
            const std::string& results_csv)
{
    ...
    if (!runner) 
    {
        throw std::runtime_error("Failed to create runner");
    }
...
{
    // Start power logger
    Start_kv260_power_log(TEST_C3_POWER_RESULT_CSV_PATH);
